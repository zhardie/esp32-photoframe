...
const presetOptions = [
  { title: "Compressed Dynamic Range", value: "cdr" },
...
<template>
  <v-card style="overflow: visible">
    ...
    >
      ...
      <v-tab value="autoRotate">
        Auto Rotate
      </v-tab>
      <v-tab value="power">
        Power
      </v-tab>
      <v-tab value="homeAssistant">
        Home Assistant
      </v-tab>
          ...
          <div class="pa-4">
            ...
            <v-row>
              ...
              >
                ...
                >
                  <template #append>
                    <span class="text-body-2">{{ settingsStore.params.saturation.toFixed(2) }}</span>
                  </template>
                </v-slider>
              </v-col>
